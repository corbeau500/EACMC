...
<div class="container">
  <div class="row">
    <div class="col-md-12">
			<div class="banner">
				<h2><span>Nos Ministeres</span></h2>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="single_blog_post clearfix" data-animated="fadeInUp">
							<div class="single_blog_post_descr">
								...
								<div class="single_blog_post_title">Découvrez le ministère de l'école du dimanche</div>

							</div>
							<div class="single_blog_post_img"><img src="uploads/08432130.jpg" alt="" /></div>
					...
					<div class="sidebar col-lg-3 col-md-3 padbot50">
						...
						<div class="sidepanel widget_meta">
							<ul>
								<?php include('pages/ministerlink.php');?>
							</ul>
						</div><!-- //META WIDGET -->
