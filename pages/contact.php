...
<div id="contact" class="section wb">
		<div class="container">
				<div class="section-title text-center">
						<h3>Nous adresser un message, une demande,...</h3>
						<p class="lead">Veuillez remplir le formulaire ci-dessous<br></p>
				</div><!-- end title -->
										...
										<form id="contactform" class="row" action="contact.php" name="contactform" method="post">
												<fieldset class="row">
														...
														<div class="text-center cont-btn">
																<button type="submit" value="SEND" id="submit" class="btn11"><span>ENVOYER</span></button>
														</div>
												</fieldset>
										</form>
								</div>
	...
	<div class="row">
		<div class="offset-md-1 col-sm-10 col-md-10 offset-sm-1 pd-add">
			<div class="address-item">
				...
				<h3>Pointe Noire</h3>
				<p>Terminus Océan du Nord
					<br> Quartier Nkouikou</p>
			</div>
			<div class="address-item">
				<div class="address-icon">
